...
const ResultElement: FC<Props> = memo(
  ({
    ...
    <Flexbox flexDirection="column" gap={16}>
      <BarracksElementalInfo element={element} oldBarrackParams={oldParams.barracks} barrackParams={params.barracks} />
      <Divider size="sm" />
      <Title order={5}>Параметры талантов</Title>
      <BarracksTalentsInfo element={element} oldParameters={oldParams.talents} parameters={params.talents} />
      <Divider size="sm" />
