  ...
  ({
    ...
    return (
      <Flex className={className} direction="column" gap={8}>
        <Title order={4}>
          <FormattedMessage defaultMessage="Новый уровень магии ведьмы" />{' '}
          {spentResources.witchResources_lightReagents === 0 ? (
            <Text c="dimmed">
              <FormattedMessage defaultMessage="Нет изменений" />
            </Text>
          ) : (
            ''
          )}
        ...
        <Divider />
        <Title order={4}>
          <FormattedMessage defaultMessage="Новые уровни камней ведьмы" />{' '}
          {spentResources.witchResources_greenWitchPotion === 0 ? (
            <Text c="dimmed">
              <FormattedMessage defaultMessage="Нет изменений" />
            </Text>
          ) : (
