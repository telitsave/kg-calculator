    ...
    <Flex className={className} direction="column" gap={16}>
        ...
        <Accordion defaultValue="heroes" variant="contained">
          {sortedHeroes.length > 0 && (
            <Accordion.Item value="heroes">
              <Accordion.Control>
                <FormattedMessage defaultMessage="Прокачка героев" />
              </Accordion.Control>
              <Accordion.Panel>
          ...
          {sortedExperienceHeroes.length > 0 && (
            <Accordion.Item value="experience">
              <Accordion.Control>
                <FormattedMessage defaultMessage="Потрачено на опыт" />
              </Accordion.Control>
              <Accordion.Panel>
                <Flex direction="column" gap={8}>
      ...
      <Flex direction="column" gap={8}>
        <Flex gap={4} align="center">
          ...
          <Text>
            <FormattedMessage defaultMessage="Потрачено всего: " /> {results.spentResources.heroesResources_n || 0}
          </Text>
        </Flex>
        <Flex gap={4} align="center">
          <ResourceIcon resourceType="heroesResources_r" />
          <Text>
            <FormattedMessage defaultMessage="Потрачено всего: " /> {results.spentResources.heroesResources_r || 0}
          </Text>
        </Flex>
        <Flex gap={4} align="center">
          <ResourceIcon resourceType="heroesResources_sr" />
          <Text>
            <FormattedMessage defaultMessage="Потрачено всего: " /> {results.spentResources.heroesResources_sr || 0}
          </Text>
        </Flex>
        <Flex gap={4} align="center">
          <ResourceIcon resourceType="heroesResources_ssr" />
          <Text>
            <FormattedMessage defaultMessage="Потрачено всего: " /> {results.spentResources.heroesResources_ssr || 0}
          </Text>
        </Flex>
        ...
        {(results.spentDistributionCards && (
          <Flex gap={4} align="center">
            <ResourceIcon resourceType="heroesResources_ssr" />
            <Text>
              <FormattedMessage defaultMessage="Потрачено самовыбора: " /> {results.spentDistributionCards || 0}
            </Text>
          </Flex>
        )) ||
          null}
        ...
        {(results.gettingStars && (
          <Flex gap={4} align="center">
            ...
            <Text>
              <FormattedMessage defaultMessage="Прокачано: " /> {results.gettingStars}
            </Text>
          </Flex>
        )) ||
          null}
