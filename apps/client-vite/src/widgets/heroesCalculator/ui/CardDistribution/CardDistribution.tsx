...
const CardDistribution: FC<Props> = memo(
  ({ className, heroId, stars, bars, cards, distributionCards, rank, element, name, disabled = false, onSetCards }) => {
    ...
    }, [onSetCards, heroId, stars, bars, cards, distributionCards, neededCardsForNextStar])
    ...
    }, [onSetCards, heroId, stars, bars, cards, distributionCards, spentCardsForPrevStar])
      ...
      <Paper shadow="sm" p="md" withBorder>
        ...
        >
          ...
          >
            ...
            >
              <FormattedMessage defaultMessage="Использовано " />
              <ResourceIcon className={css.icon} resourceType="heroesResources_ssr" />: {distributionCards}
            </Text>
            <Text
              size="sm"
              display="flex"
            ...
            >
              <FormattedMessage defaultMessage="До " />
              <div className={css.bar} />: {neededCardsForNextLevel}
            </Text>
            <Text
              size="sm"
              display="flex"
            ...
            >
              <FormattedMessage defaultMessage="До " />
              <FaStar className={css.star} color="var(--mantine-color-yellow-filled)" />: {neededCardsForNextStar}
            </Text>
          </Flex>
        </Flex>
      </Paper>
