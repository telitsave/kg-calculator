    ...
    <Stack maw={600}>
      ...
      >
        <Accordion.Item value="dragon">
          <Accordion.Control>
            <FormattedMessage defaultMessage="Дракон" />
          </Accordion.Control>
          <Accordion.Panel>
        ...
        <Accordion.Item value="castle">
          <Accordion.Control>
            <FormattedMessage defaultMessage="Замок" />
          </Accordion.Control>
          <Accordion.Panel>
            <Flexbox flexDirection="column" gap={8}>
        ...
        <Accordion.Item value="witch">
          <Accordion.Control>
            <FormattedMessage defaultMessage="Ведьма" />
          </Accordion.Control>
          <Accordion.Panel>
            <WitchPowerInput />
            <Divider mt={8} mb={8} />
        ...
        <Accordion.Item value="barracks">
          <Accordion.Control>
            <FormattedMessage defaultMessage="Казарма" />
          </Accordion.Control>
          <Accordion.Panel>
        ...
        <Accordion.Item value="blacksmith">
          <Accordion.Control>
            <FormattedMessage defaultMessage="Кузнец" />
          </Accordion.Control>
          <Accordion.Panel>
            <Flexbox flexDirection="column" gap={8}>
        ...
        <Accordion.Item value="gallery">
          <Accordion.Control>
            <FormattedMessage defaultMessage="Галерея" />
          </Accordion.Control>
          <Accordion.Panel>
            <Flexbox flexDirection="column" gap={8}>
              <GalleryInput />
