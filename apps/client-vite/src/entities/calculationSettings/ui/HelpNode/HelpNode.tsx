        ...
        <Flexbox flexDirection="column">
          <FormattedMessage
            defaultMessage="
              ...
              <Text>Если, к примеру, стихия огня прокачана до максимума, менять можно только книги огня на книги талантов.</Text>
            "
            values={{
    ...
    case 'canUseRandomBarracksBooks':
      return (
        <Flexbox flexDirection="column">
          <FormattedMessage
            defaultMessage={`
              <Text>Книги самовыбора будут обменяны на книги выбранной стихии, которую хочется прокачивать в первом приоритете.</Text>
              <Text>Если стихия прокачана максимально, и не включен параметр "Менять книги-излишки на таланты", книги самовыбора
              использоваться не будут.</Text>
              `}
            values={{
              Text: (chunks) => <Text>{chunks}</Text>,
            }}
    ...
    case 'canUseTalentsToNonPriorityElements':
      return (
        <Flexbox flexDirection="column">
          <FormattedMessage
            defaultMessage={`
              <Text>Для наиболее эффективной прокачки, лучше не тратить книги талантов и короны на те стихии, которые не
            являются основными, так как это не даст эффективный прирост мощи.</Text>
              <Text>Однако, если это не так принципиально, а так же хочется набрать больше очков в ивентах, есть смысл потратить
            ресурсы и на остальные стихии.</Text>
              <Text>Ресурсы будут потрачены в порядке стихий, как они идут в казарме (или указаны в калькуляторе). Но в первую
            очередь ресурсы будут потрачены на приоритетную стихию.</Text>
              `}
            values={{
              Text: (chunks) => <Text>{chunks}</Text>,
            }}
    ...
    case 'usePossibleCastleLimit':
      return (
        <Flexbox flexDirection="column">
          <FormattedMessage
            defaultMessage={`
              <Text>На основе ваших ресурсов и параметров будет определен максимальный уровень замка, который можно прокачать.</Text>
              <Text>Далее, этот максимальный уровень замка будет использоваться как предел при прокачке дракона и расчета очков.</Text>
    ...
    case 'spentToArtifactBarracks':
      return (
        <Flexbox flexDirection="column">
          <FormattedMessage
            defaultMessage={`
              <Text>Все оставшие книги казармы (в том числе книги самовыбора) будут потрачены в артефакт для набора очков СК/ЭМ</Text>
              <Text>Потратить книги казармы в артефакт возможно только тогда, когда все стихии будут прокачаны до 9 ранга.</Text>
              <Text>Стоит учесть, что сначала книги казармы будут обменены на книги талантов (если включена соответствующая
            настройка), а только потом остатки будут влиты в артефакт.</Text>
              `}
            values={{
              Text: (chunks) => <Text>{chunks}</Text>,
            }}
        ...
        <Flexbox flexDirection="column">
          <FormattedMessage
            defaultMessage={`
              ...
              <Text>Стоит учесть, что если включены настройки учета замка, то сначала ресурсы будут потрачены на прокачку
            дракона, пока не дойдет до лимита по уровню замка. И только при достижении лимита, все оставшиеся ресурсы
            будут потрачены в артефакт.</Text>
