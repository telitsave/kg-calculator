...
const HeroCard: FC<Props> = memo(
  ({
    ...
    const handleSetCards = useCallback(
      ...
      [onSetCards, heroId, stars, bars, distributionCards],
    )
          ...
          >
            ...
            <NumberInput
              ...
              label={
                <Flex gap={4}>
                  <Text fw={700} size="xs">
                    <FormattedMessage defaultMessage="Количество карт" />
                  </Text>
                  <HelpButton
                    helpContent={
                      <FormattedMessage defaultMessage="Количество карт берем в игре с экрана со списком всех героев (там количество указано с +1 обязательной картой). Если героя нет в наличии, выставляем 0 карт." />
                    }
                  />
                </Flex>
              }
